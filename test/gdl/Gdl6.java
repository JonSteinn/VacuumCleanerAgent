...
public class Gdl6 {
    ...
    public void completenessAStarTest() {
        assertEquals("Complete A*", 159, this.aStar.getCost());
    }
    ...
    public void completenessUniformCostSearchTest() {
        assertEquals("Complete UCS", 159, this.ucs.getCost());
    }
