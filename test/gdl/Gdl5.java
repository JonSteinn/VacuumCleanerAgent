...
public class Gdl5 {
    ...
    public void completenessAStarTest() {
        assertEquals("Complete A*", 170, this.aStar.getCost());
    }
    ...
    public void completenessUniformCostSearchTest() {
        assertEquals("Complete UCS", 170, this.ucs.getCost());
    }
