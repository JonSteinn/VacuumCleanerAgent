...
public class Gdl3 {
    ...
    public void completenessAStarTest() {
        assertEquals("Complete A*", 286, this.aStar.getCost());
    }
    ...
    public void completenessUniformCostSearchTest() {
        assertEquals("Complete UCS", 286, this.ucs.getCost());
    }
