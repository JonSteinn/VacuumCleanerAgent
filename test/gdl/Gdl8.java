...
public class Gdl8 {
    ...
    public void completenessAStarTest() {
        assertEquals("Complete A*", 259, this.aStar.getCost());
    }
    ...
    public void completenessUniformCostSearchTest() {
        assertEquals("Complete UCS", 259, this.ucs.getCost());
    }
