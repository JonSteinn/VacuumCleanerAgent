...
public class Gdl9 {
    ...
    public void completenessAStarTest() {
        assertEquals("Complete A*", 270, this.aStar.getCost());
    }
    ...
    public void completenessUniformCostSearchTest() {
        assertEquals("Complete UCS", 270, this.ucs.getCost());
    }
