...
public class Gdl7 {
    ...
    public void completenessAStarTest() {
        assertEquals("Complete A*", 222, this.aStar.getCost());
    }
    ...
    public void completenessUniformCostSearchTest() {
        assertEquals("Complete UCS", 222, this.ucs.getCost());
    }
